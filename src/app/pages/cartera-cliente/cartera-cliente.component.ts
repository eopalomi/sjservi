...
/**************** CONFIGURACION DE LA TABLA 02 ***************/
  ...
  PAGE_CONFIG: { page_title: string, page_rows: any[], button_page: any[] } = {
    page_title: 'Filtros',
    page_rows: [{ 
  ...
  // CONFIGURACION DE LA PAGINA
  PAGE_CONFIG_TABLA: { page_title: string, page_rows: any[], title_column: any[], type_column: any[], opc_page: any[], button_page: any[] } = {
  ...
  PAGE_CONFIG_TABLA_02: { page_title: string, page_rows: any[], title_column: any[], type_column: any[], opc_page: any[], button_page: any[] } = {
